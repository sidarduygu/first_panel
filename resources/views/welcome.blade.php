    ...
    <div class="feed">
      ...
      <div class="tweetBox">
        <form action="{{route('create.tweet')}}" method="post">
			@csrf
			<input type="text" value="Ogur Uyanik" name="name" hidden />
			<input type="text" value="ogur.uyanik" name="username" hidden />
			<input type="text" value="https://www.focus2move.com/wp-content/uploads/2020/01/Tesla-Roadster-2020-1024-03.jpg" name="image" hidden />
            ...
            <div class="post__headerText">
              <h3>
                ...
                <span class="post__headerSpecial"
                  ><span class="material-icons post__badge"> verified </span>{{'@'.$tweet->username}}</span
                >
              </h3>
            </div>
